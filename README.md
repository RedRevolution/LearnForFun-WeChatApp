...
- 2020.5.22 17:00：删除分享（未通），优化资料分享相关，收藏资料分享相关（PG）
- 2020.5.22 23:38: 解决了删除分享问题，聊天记录一次性加载500条以内，因为scroll to view 不起作用(DM)
- 2020.5.23 11:27 解决删除资料分享问题，资料分享显示自动换行（PG）
- 2020.5.25 18:18: 修复群成员列表可以向右滑的问题，开放所有人可查看群成员列表，仅管理员删除(DM)
- 2020.5.25 21:06: 增加账号注销，加入群组ID不存在时提示(DM)
- 2020.5.25 23:48:修复bug：返回前页和showtoast冲突问题（可能没全改完）、课表页点击跳转统一认证登录没反应、修改日程的格式bug、同意解散群组后不返回前页的bug 优化：增加分享列表的nodata模版（PG)
- 2020.5.26 00:21:注销账号二次确认(DM)
- 2020.5.26 10:20:修复bug：两个弹窗问题（PG）
- 2020.5.26 11:35:修复注销账号和其他bug(DM)
- 2020.5.27 19:12:聊天支持emoji(DM)
- 2020.6.4 21:33：修复响应过程中多次点击添加日程创建多个问题
## 1. 开启项目
